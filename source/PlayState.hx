...
class PlayState extends MusicBeatState
{
	...
	public static var noteBools:Array<Bool> = [false, false];
	...
	public var dialogue:Array<String> = ['electric:blah blah blah', 'bf:coolswag'];
	public var endDialogue:Array<String> = ['electric:blah blah blah', 'bf:coolswag'];
	...
	override public function create()
	{
			...
			case 'park':
				{
					...
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('parkBG', 'week1'));
		...
		var doofend:DialogueBox = new DialogueBox(false, endDialogue);
	...
	private function keyShit():Void // I've invested in emma stocks
	{
		...
		if (pressArray.contains(true) && /*!boyfriend.stunned && */ generatedMusic)
		{
			...
			// trace('\nCURRENT LINE:\n' + directionsAccounted); // this shit annoys me so much
